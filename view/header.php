    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav">
          ...
          <a class="nav-link" aria-current="page" href="?c=controller_user">  Ver Habitaciones</a>
        </div>
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav">
          ...
          <a class="nav-link" aria-current="page" href="?c=controller_management">  Administrar Habitaciones</a>
        </div>
        <div class="navbar-nav ml-auto" id="header-sesion">
          <a class="nav-link" href="?c=controller_logout">Cerrar Sesión</a>
        </div>
